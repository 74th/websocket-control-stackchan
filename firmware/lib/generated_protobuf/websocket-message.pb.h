...
typedef enum _stackchan_websocket_v1_MessageKind {
    ...
    stackchan_websocket_v1_MessageKind_MESSAGE_KIND_TONE_CMD = 11,
    stackchan_websocket_v1_MessageKind_MESSAGE_KIND_TONE_DONE_EVT = 12
...
typedef struct _stackchan_websocket_v1_StateCommand {
    ...
    uint32_t listening_duration_ms; /* used when state=LISTENING, 0 means silence-based stop */
...
typedef struct _stackchan_websocket_v1_ToneCommand {
    float frequency;
    uint32_t duration_ms;
} stackchan_websocket_v1_ToneCommand;

typedef struct _stackchan_websocket_v1_ToneDoneEvent {
    bool done;
} stackchan_websocket_v1_ToneDoneEvent;
...
typedef struct _stackchan_websocket_v1_WebSocketMessage {
    ...
    union {
        ...
        stackchan_websocket_v1_ToneCommand tone_cmd;
        stackchan_websocket_v1_ToneDoneEvent tone_done_evt;
    } body;
...
#define _stackchan_websocket_v1_MessageKind_MAX stackchan_websocket_v1_MessageKind_MESSAGE_KIND_TONE_DONE_EVT
#define _stackchan_websocket_v1_MessageKind_ARRAYSIZE ((stackchan_websocket_v1_MessageKind)(stackchan_websocket_v1_MessageKind_MESSAGE_KIND_TONE_DONE_EVT+1))
...
#define stackchan_websocket_v1_StateCommand_init_default {_stackchan_websocket_v1_StackchanState_MIN, 0}
...
#define stackchan_websocket_v1_ToneCommand_init_default {0, 0}
#define stackchan_websocket_v1_ToneDoneEvent_init_default {0}
...
#define stackchan_websocket_v1_StateCommand_init_zero {_stackchan_websocket_v1_StackchanState_MIN, 0}
...
#define stackchan_websocket_v1_ToneCommand_init_zero {0, 0}
#define stackchan_websocket_v1_ToneDoneEvent_init_zero {0}
...
#define stackchan_websocket_v1_StateCommand_listening_duration_ms_tag 2
...
#define stackchan_websocket_v1_ToneCommand_frequency_tag 1
#define stackchan_websocket_v1_ToneCommand_duration_ms_tag 2
#define stackchan_websocket_v1_ToneDoneEvent_done_tag 1
...
#define stackchan_websocket_v1_WebSocketMessage_tone_cmd_tag 38
#define stackchan_websocket_v1_WebSocketMessage_tone_done_evt_tag 39
...
X(a, STATIC,   ONEOF,    MESSAGE,  (body,tone_cmd,body.tone_cmd),  38) \
X(a, STATIC,   ONEOF,    MESSAGE,  (body,tone_done_evt,body.tone_done_evt),  39)
...
#define stackchan_websocket_v1_WebSocketMessage_body_tone_cmd_MSGTYPE stackchan_websocket_v1_ToneCommand
#define stackchan_websocket_v1_WebSocketMessage_body_tone_done_evt_MSGTYPE stackchan_websocket_v1_ToneDoneEvent
...
X(a, STATIC,   SINGULAR, UINT32,   listening_duration_ms,   2)
...
#define stackchan_websocket_v1_ToneCommand_FIELDLIST(X, a) \
X(a, STATIC,   SINGULAR, FLOAT,    frequency,         1) \
X(a, STATIC,   SINGULAR, UINT32,   duration_ms,       2)
#define stackchan_websocket_v1_ToneCommand_CALLBACK NULL
#define stackchan_websocket_v1_ToneCommand_DEFAULT NULL

#define stackchan_websocket_v1_ToneDoneEvent_FIELDLIST(X, a) \
X(a, STATIC,   SINGULAR, BOOL,     done,              1)
#define stackchan_websocket_v1_ToneDoneEvent_CALLBACK NULL
#define stackchan_websocket_v1_ToneDoneEvent_DEFAULT NULL
...
extern const pb_msgdesc_t stackchan_websocket_v1_ToneCommand_msg;
extern const pb_msgdesc_t stackchan_websocket_v1_ToneDoneEvent_msg;
...
#define stackchan_websocket_v1_ToneCommand_fields &stackchan_websocket_v1_ToneCommand_msg
#define stackchan_websocket_v1_ToneDoneEvent_fields &stackchan_websocket_v1_ToneDoneEvent_msg
...
#define stackchan_websocket_v1_StateCommand_size 8
#define stackchan_websocket_v1_StateEvent_size   2
#define stackchan_websocket_v1_ToneCommand_size  11
#define stackchan_websocket_v1_ToneDoneEvent_size 2
